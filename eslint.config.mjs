...
export default defineConfig([
  ...
  {
    files: ['features/steps/**/*.{js,ts}', '**/features/steps/**/*.{js,ts}'],
    plugins: { cucumber },
    rules: {
      // Turn off Playwright test-specific rules that don't apply to step defs
      ...
      // Relax some TS rules for step files
      '@typescript-eslint/no-explicit-any': 'off',
      '@typescript-eslint/no-unused-vars': 'off',
      '@typescript-eslint/naming-convention': 'off',
      // Cucumber plugin rules (enable as desired)
  ...
  {
    files: ['**/*.ts'],
    ignores: ['features/steps/**/*.{ts,js}', 'src/fixtures/ExtendedFixtures.ts'],
    rules: {
